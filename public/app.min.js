...
let html=listeTemplate(contenu);dataMenuListe.exercice='réécriture';const menuListe=menuListeTemplate(dataMenuListe);menu.html(menuListe);app.html(html);},'dictee/:id':function(params){let contenu={'did':params.id,'exercice':'dictée','consigne':MSG.consigneDictee,'consigneDicteeAmenagee':MSG.consigneDicteeAmenagee,'lien':'ecouter','legende':'écoute'};let html=accueilExerciceTemplate(contenu);dataMenuDictee.did=params.id;dataMenuDictee.exercice='dictée';let menuD=menuExerciceTemplate(dataMenuDictee);menu.html(menuD);app.html(html);},'reecriture/:id':function(params){let contenu={'did':params.id,'exercice':'réécriture','consigne':"D'abord, lisez attentivement la consigne de la \
          réécriture. Notez au brouillon les passages à transformer",'lien':'consigne','legende':'consigne'}
let html=accueilExerciceTemplate(contenu);dataMenuReecriture.did=params.id;dataMenuReecriture.exercice='réécriture';let menuR=menuExerciceTemplate(dataMenuReecriture);menu.html(menuR);app.html(html);},'ecouter/:id':function(params){let rubriquesJSONdata=require('../static/config/rubriques_dictam.json').rubriques;let source="./static/data/dictee"+params.id+".json";let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==='true'){source="./static/data/dictam"+params.id+".json";}
fetch(source).then((response)=>{return response.json();}).then((data)=>{let contenu={'did':params.id,'sources':formatAudio,'fourni':data.fourni,'lacunes':data.lacunes||"",'exercice':'dictée','rubs':rubriquesJSONdata,'mots':data.consigne};let html=ecouterTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuEcouter.did=params.id;dataMenuEcouter.exercice='dictée';let menuD=menuExerciceTemplate(dataMenuEcouter);menu.html(menuD);},'saisir/dictee/:id':function(params){let source="./static/data/dictee"+params.id+".json";let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==='true'){source="./static/data/dictam"+params.id+".json";}
...
return undefined};return((stack1=lookupProperty(helpers,"if").call(depth0!=null?depth0:(container.nullContext||{}),(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(9,data,0),"inverse":container.program(11,data,0),"data":data,"loc":{"start":{"line":35,"column":2},"end":{"line":40,"column":9}}}))!=null?stack1:"");},"9":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</a>\n";},"13":function(container,depth0,helpers,partials,data){return"  aménagées\n";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"<!-- ==================================\n *            e j D i c t o             *\n * ==================================== *\n * (c)2012-2020 - Patrick Cardona       *\n * Licence GPL version 3 ou ultérieure  *\n * VOIR la licence complète à la racine *\n * ==================================== -->\n\n <!-- Navigation : Menu : menuTemplate.hbs -->\n\n<!-- ============================================ -->\n\n<!-- Sidebar -->\n<div class=\"w3-sidebar w3-bar-block\" style=\"display:none\" id=\"menu_gauche\">\n  <button onclick=\"refermer_navigation()\" class=\"w3-bar-item w3-button w3-large w3-text-teal\">Fermer \n  <i class=\"icon-fermer\"></i></button>\n"
+((stack1=lookupProperty(helpers,"each").call(alias1,(depth0!=null?lookupProperty(depth0,"items"):depth0),{"name":"each","hash":{},"fn":container.program(1,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":17,"column":0},"end":{"line":20,"column":11}}}))!=null?stack1:"")
+"\n</div>\n\n<!-- Contexte -->\n<div class=\"w3-"
+container.escapeExpression(((helper=(helper=lookupProperty(helpers,"couleur")||(depth0!=null?lookupProperty(depth0,"couleur"):depth0))!=null?helper:container.hooks.helperMissing),(typeof helper==="function"?helper.call(alias1,{"name":"couleur","hash":{},"data":data,"loc":{"start":{"line":25,"column":15},"end":{"line":25,"column":26}}}):helper)))
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(3,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":26,"column":0},"end":{"line":50,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],50:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"  <a href=\""
...
+" \n  </button>\n";},"7":function(container,depth0,helpers,partials,data){return"  triadic\n";},"9":function(container,depth0,helpers,partials,data){return"class=\"rubrique\"\n";},"11":function(container,depth0,helpers,partials,data){return"      Puis affichez le texte aménagé \n            et notez vos choix au brouillon avec méthode : <br>\n            <ol><li>Mon choix 1 : ...</li><li>Etc</li></ol>\n";},"13":function(container,depth0,helpers,partials,data){return"   Puis écoutez-la de nouveau, en la notant sur votre \n   cahier de brouillon. \n";},"15":function(container,depth0,helpers,partials,data,blockParams){var stack1,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"    </ul>\n</div>\n</div>\n";},"16":function(container,depth0,helpers,partials,data,blockParams){var alias1=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
return undefined};return"        <button class=\"w3-button w3-right\" \n        onclick=\"navigator.share({title: 'ejDicto: \n"
