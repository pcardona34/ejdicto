(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){/*!chibi 3.0.9, Copyright 2012-2017 Kyle Barrow, released under MIT license */(function(){'use strict';var readyfn=[],loadedfn=[],domready=false,pageloaded=false,jsonpcount=0,d=document,w=window;function fireReady(){var i;domready=true;for(i=0;i<readyfn.length;i+=1){readyfn[i]();}
readyfn=[];}
function fireLoaded(){var i;pageloaded=true;if(!domready){fireReady();}
for(i=0;i<loadedfn.length;i+=1){loadedfn[i]();}
loadedfn=[];}
if(d.addEventListener){d.addEventListener('DOMContentLoaded',fireReady,false);w.addEventListener('load',fireLoaded,false);}else if(d.attachEvent){d.attachEvent('onreadystatechange',fireReady);w.attachEvent('onload',fireLoaded);}else{w.onload=fireLoaded;}
function nodeLoop(fn,nodes){var i;for(i=nodes.length-1;i>=0;i-=1){fn(nodes[i]);}}
function cssCamel(property){return property.replace(/-\w/g,function(result){return result.charAt(1).toUpperCase();});}
function computeStyle(elm,property){return(elm.currentStyle)?elm.currentStyle[cssCamel(property)]:(w.getComputedStyle)?w.getComputedStyle(elm,null).getPropertyValue(property):null;}
function queryPair(name,value){return encodeURIComponent(name).replace(/%20/g,'+')+'='+encodeURIComponent(value).replace(/%20/g,'+');}
function setCss(elm,property,value){try{elm.style[cssCamel(property)]=value;}catch(e){console.error('Could not set css style property "'+property+'".');}}
function showCss(elm){elm.style.display='';if(computeStyle(elm,'display')==='none'){elm.style.display='block';}}
function serializeData(nodes){var querystring='',subelm,i,j;if(nodes.constructor===Object){for(subelm in nodes){if(nodes.hasOwnProperty(subelm)){if(nodes[subelm].constructor===Array){for(i=0;i<nodes[subelm].length;i+=1){querystring+='&'+queryPair(subelm,nodes[subelm][i]);}}else{querystring+='&'+queryPair(subelm,nodes[subelm]);}}}}else{nodeLoop(function(elm){if(elm.nodeName==='FORM'){for(i=0;i<elm.elements.length;i+=1){subelm=elm.elements[i];if(!subelm.disabled){switch(subelm.type){case'button':case'image':case'file':case'submit':case'reset':break;case'select-one':if(subelm.length>0){querystring+='&'+queryPair(subelm.name,subelm.value);}
break;case'select-multiple':for(j=0;j<subelm.length;j+=1){if(subelm[j].selected){querystring+='&'+queryPair(subelm.name,subelm[j].value);}}
break;case'checkbox':case'radio':if(subelm.checked){querystring+='&'+queryPair(subelm.name,subelm.value);}
break;default:querystring+='&'+queryPair(subelm.name,subelm.value);}}}}},nodes);}
return(querystring.length>0)?querystring.substring(1):'';}
function classHelper(classes,action,nodes){var classarray,search,replace,i,has=false;if(classes){classarray=classes.split(/\s+/);nodeLoop(function(elm){for(i=0;i<classarray.length;i+=1){search=new RegExp('\\b'+classarray[i]+'\\b','g');replace=new RegExp(' *'+classarray[i]+'\\b','g');if(action==='remove'){elm.className=elm.className.replace(replace,'');}else if(action==='toggle'){elm.className=(elm.className.match(search))?elm.className.replace(replace,''):elm.className+' '+classarray[i];}else if(action==='has'){if(elm.className.match(search)){has=true;break;}}}},nodes);}
return has;}
function insertHtml(value,position,nodes){var tmpnodes,tmpnode;if(value){nodeLoop(function(elm){tmpnodes=d.createElement('div');tmpnodes.innerHTML=value;while((tmpnode=tmpnodes.lastChild)!==null){try{if(position==='before'){elm.parentNode.insertBefore(tmpnode,elm);}else if(position==='after'){elm.parentNode.insertBefore(tmpnode,elm.nextSibling);}else if(position==='append'){elm.appendChild(tmpnode);}else if(position==='prepend'){elm.insertBefore(tmpnode,elm.firstChild);}}catch(e){break;}}},nodes);}}
function chibi(selector){var cb,nodes=[],json=false,nodelist,i;if(selector){if(selector.nodeType&&selector.nodeType===1){nodes=[selector];}else if(typeof selector==='object'){json=(typeof selector.length!=='number');nodes=selector;}else if(typeof selector==='string'){if(!d.querySelectorAll){d.querySelectorAll=function(selector){var style,head=d.getElementsByTagName('head')[0],allnodes,selectednodes=[],i;style=d.createElement('STYLE');style.type='text/css';if(style.styleSheet){style.styleSheet.cssText=selector+' {a:b}';head.appendChild(style);allnodes=d.getElementsByTagName('*');for(i=0;i<allnodes.length;i+=1){if(computeStyle(allnodes[i],'a')==='b'){selectednodes.push(allnodes[i]);}}
head.removeChild(style);}
return selectednodes;};}
nodelist=d.querySelectorAll(selector);for(i=0;i<nodelist.length;i+=1){nodes[i]=nodelist[i];}}}
cb=json?{}:nodes;cb.ready=function(fn){if(fn){if(domready){fn();return cb;}else{readyfn.push(fn);}}};cb.loaded=function(fn){if(fn){if(pageloaded){fn();return cb;}else{loadedfn.push(fn);}}};cb.each=function(fn){if(typeof fn==='function'){nodeLoop(function(elm){return fn.apply(elm,arguments);},nodes);}
return cb;};cb.first=function(){return chibi(nodes.shift());};cb.last=function(){return chibi(nodes.pop());};cb.odd=function(){var odds=[],i;for(i=0;i<nodes.length;i+=2){odds.push(nodes[i]);}
return chibi(odds);};cb.even=function(){var evens=[],i;for(i=1;i<nodes.length;i+=2){evens.push(nodes[i]);}
return chibi(evens);};cb.hide=function(){nodeLoop(function(elm){elm.style.display='none';},nodes);return cb;};cb.show=function(){nodeLoop(function(elm){showCss(elm);},nodes);return cb;};cb.toggle=function(){nodeLoop(function(elm){if(computeStyle(elm,'display')==='none'){showCss(elm);}else{elm.style.display='none';}},nodes);return cb;};cb.remove=function(){nodeLoop(function(elm){try{elm.parentNode.removeChild(elm);}catch(e){}},nodes);return chibi();};cb.css=function(property,value){if(property){if(value||value===''){nodeLoop(function(elm){setCss(elm,property,value);},nodes);return cb;}
if(nodes[0]){if(nodes[0].style[cssCamel(property)]){return nodes[0].style[cssCamel(property)];}
if(computeStyle(nodes[0],property)){return computeStyle(nodes[0],property);}}}};cb.getClass=function(){if(nodes[0]&&nodes[0].className.length>0){return nodes[0].className.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,'').replace(/\s+/,' ');}};cb.setClass=function(classes){if(classes||classes===''){nodeLoop(function(elm){elm.className=classes;},nodes);}
return cb;};cb.addClass=function(classes){if(classes){nodeLoop(function(elm){elm.className+=' '+classes;},nodes);}
return cb;};cb.removeClass=function(classes){classHelper(classes,'remove',nodes);return cb;};cb.toggleClass=function(classes){classHelper(classes,'toggle',nodes);return cb;};cb.hasClass=function(classes){return classHelper(classes,'has',nodes);};cb.html=function(value){if(value||value===''){nodeLoop(function(elm){elm.innerHTML=value;},nodes);return cb;}
if(nodes[0]){return nodes[0].innerHTML;}};cb.htmlBefore=function(value){insertHtml(value,'before',nodes);return cb;};cb.htmlAfter=function(value){insertHtml(value,'after',nodes);return cb;};cb.htmlAppend=function(value){insertHtml(value,'append',nodes);return cb;};cb.htmlPrepend=function(value){insertHtml(value,'prepend',nodes);return cb;};cb.attr=function(property,value){if(property){property=property.toLowerCase();if(value||value===''){nodeLoop(function(elm){if(property==='style'){elm.style.cssText=value;}else if(property==='class'){elm.className=value;}else{elm.setAttribute(property,value);}},nodes);return cb;}
if(nodes[0]){if(property==='style'){if(nodes[0].style.cssText){return nodes[0].style.cssText;}}else if(property==='class'){if(nodes[0].className){return nodes[0].className;}}else{if(nodes[0].getAttribute(property)){return nodes[0].getAttribute(property);}}}}};cb.data=function(key,value){if(key){return cb.attr('data-'+key,value);}};cb.val=function(value){var values,i,j;if(value||value===''){nodeLoop(function(elm){switch(elm.nodeName){case'SELECT':if(typeof value==='string'||typeof value==='number'){value=[value];}
for(i=0;i<elm.length;i+=1){for(j=0;j<value.length;j+=1){elm[i].selected='';if(elm[i].value===value[j]){elm[i].selected='selected';break;}}}
break;case'INPUT':case'TEXTAREA':case'BUTTON':elm.value=value;break;}},nodes);return cb;}
if(nodes[0]){switch(nodes[0].nodeName){case'SELECT':values=[];for(i=0;i<nodes[0].length;i+=1){if(nodes[0][i].selected){values.push(nodes[0][i].value);}}
return(values.length>1)?values:values[0];case'INPUT':case'TEXTAREA':case'BUTTON':return nodes[0].value;}}};cb.checked=function(check){if(typeof check==='boolean'){nodeLoop(function(elm){if(elm.nodeName==='INPUT'&&(elm.type==='checkbox'||elm.type==='radio')){elm.checked=check;}},nodes);return cb;}
if(nodes[0]&&nodes[0].nodeName==='INPUT'&&(nodes[0].type==='checkbox'||nodes[0].type==='radio')){return(!!nodes[0].checked);}};cb.on=function(event,fn){if(selector===w||selector===d){nodes=[selector];}
nodeLoop(function(elm){if(d.addEventListener){elm.addEventListener(event,fn,false);}else if(d.attachEvent){elm[event+fn]=function(){return fn.apply(elm,arguments);};elm.attachEvent('on'+event,elm[event+fn]);}},nodes);return cb;};cb.off=function(event,fn){if(selector===w||selector===d){nodes=[selector];}
nodeLoop(function(elm){if(d.addEventListener){elm.removeEventListener(event,fn,false);}else if(d.attachEvent){elm.detachEvent('on'+event,elm[event+fn]);elm[event+fn]=null;}},nodes);return cb;};cb.ajax=function(url,method,callback,nocache,nojsonp){var xhr,query=serializeData(nodes),type=(method)?method.toUpperCase():'GET',hostsearch=new RegExp('http[s]?://(.*?)/','gi'),domain=hostsearch.exec(url),timestamp='_ts='+(+new Date()),head=d.getElementsByTagName('head')[0],jsonpcallback='chibi'+(+new Date())+(jsonpcount+=1),script;if(query&&(type==='GET'||type==='DELETE')){url+=(url.indexOf('?')===-1)?'?'+query:'&'+query;query=null;}
if(type==='GET'&&!nojsonp&&domain&&w.location.host!==domain[1]){if(nocache){url+=(url.indexOf('?')===-1)?'?'+timestamp:'&'+timestamp;}
url=url.replace('=%3F','=?');if(callback&&url.indexOf('=?')!==-1){url=url.replace('=?','='+jsonpcallback);w[jsonpcallback]=function(data){try{callback(data,200);}catch(e){}
w[jsonpcallback]=undefined;};}
script=document.createElement('script');script.async=true;script.src=url;script.onload=function(){head.removeChild(script);};head.appendChild(script);}else{if(w.XMLHttpRequest){xhr=new XMLHttpRequest();}else if(w.ActiveXObject){xhr=new ActiveXObject('Microsoft.XMLHTTP');}
if(xhr){if(nocache){url+=(url.indexOf('?')===-1)?'?'+timestamp:'&'+timestamp;}
xhr.open(type,url,true);xhr.onreadystatechange=function(){if(xhr.readyState===4){if(callback){callback(xhr.responseText,xhr.status);}}};xhr.setRequestHeader('X-Requested-With','XMLHttpRequest');if(type==='POST'||type==='PUT'){xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');}
xhr.send(query);}}
return cb;};cb.get=function(url,callback,nocache,nojsonp){return cb.ajax(url,'get',callback,nocache,nojsonp);};cb.post=function(url,callback,nocache){return cb.ajax(url,'post',callback,nocache);};return cb;}
w.$=chibi;}());},{}],2:[function(require,module,exports){'use strict';exports.__esModule=true;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}
...
var inst=create();inst.create=create;_handlebarsNoConflict2['default'](inst);inst['default']=inst;exports['default']=inst;module.exports=exports['default'];},{"./handlebars/base":3,"./handlebars/exception":6,"./handlebars/no-conflict":19,"./handlebars/runtime":20,"./handlebars/safe-string":21,"./handlebars/utils":22}],3:[function(require,module,exports){'use strict';exports.__esModule=true;exports.HandlebarsEnvironment=HandlebarsEnvironment;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}
...
function moveHelperToHooks(instance,helperName,keepHelper){if(instance.helpers[helperName]){instance.hooks[helperName]=instance.helpers[helperName];if(!keepHelper){delete instance.helpers[helperName];}}}},{"./helpers/block-helper-missing":8,"./helpers/each":9,"./helpers/helper-missing":10,"./helpers/if":11,"./helpers/log":12,"./helpers/lookup":13,"./helpers/with":14}],8:[function(require,module,exports){'use strict';exports.__esModule=true;var _utils=require('../utils');exports['default']=function(instance){instance.registerHelper('blockHelperMissing',function(context,options){var inverse=options.inverse,fn=options.fn;if(context===true){return fn(this);}else if(context===false||context==null){return inverse(this);}else if(_utils.isArray(context)){if(context.length>0){if(options.ids){options.ids=[options.name];}
return instance.helpers.each(context,options);}else{return inverse(this);}}else{if(options.data&&options.ids){var data=_utils.createFrame(options.data);data.contextPath=_utils.appendContextPath(options.data.contextPath,options.name);options={data:data};}
return fn(context,options);}});};module.exports=exports['default'];},{"../utils":22}],9:[function(require,module,exports){(function(global){'use strict';exports.__esModule=true;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}
...
return ret;});};module.exports=exports['default'];}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{})},{"../exception":6,"../utils":22}],10:[function(require,module,exports){'use strict';exports.__esModule=true;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}
...
return instance.helpers['if'].call(this,conditional,{fn:options.inverse,inverse:options.fn,hash:options.hash});});};module.exports=exports['default'];},{"../exception":6,"../utils":22}],12:[function(require,module,exports){'use strict';exports.__esModule=true;exports['default']=function(instance){instance.registerHelper('log',function(){var args=[undefined],options=arguments[arguments.length-1];for(var i=0;i<arguments.length-1;i++){args.push(arguments[i]);}
var level=1;if(options.hash.level!=null){level=options.hash.level;}else if(options.data&&options.data.level!=null){level=options.data.level;}
args[0]=level;instance.log.apply(instance,args);});};module.exports=exports['default'];},{}],13:[function(require,module,exports){'use strict';exports.__esModule=true;exports['default']=function(instance){instance.registerHelper('lookup',function(obj,field,options){if(!obj){return obj;}
return options.lookupProperty(obj,field);});};module.exports=exports['default'];},{}],14:[function(require,module,exports){'use strict';exports.__esModule=true;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}
...
function resetLoggedProperties(){Object.keys(loggedProperties).forEach(function(propertyName){delete loggedProperties[propertyName];});}},{"../logger":18,"./create-new-lookup-object":15}],17:[function(require,module,exports){'use strict';exports.__esModule=true;exports.wrapHelper=wrapHelper;function wrapHelper(helper,transformOptionsFn){if(typeof helper!=='function'){return helper;}
var wrapper=function wrapper(){var options=arguments[arguments.length-1];arguments[arguments.length-1]=transformOptionsFn(options);return helper.apply(this,arguments);};return wrapper;}},{}],18:[function(require,module,exports){'use strict';exports.__esModule=true;var _utils=require('./utils');var logger={methodMap:['debug','info','warn','error'],level:'info',lookupLevel:function lookupLevel(level){if(typeof level==='string'){var levelMap=_utils.indexOf(logger.methodMap,level.toLowerCase());if(levelMap>=0){level=levelMap;}else{level=parseInt(level,10);}}
...
function passLookupPropertyOption(helper,container){var lookupProperty=container.lookupProperty;return _internalWrapHelper.wrapHelper(helper,function(options){return Utils.extend({lookupProperty:lookupProperty},options);});}},{"./base":3,"./exception":6,"./helpers":7,"./internal/proto-access":16,"./internal/wrapHelper":17,"./utils":22}],21:[function(require,module,exports){'use strict';exports.__esModule=true;function SafeString(string){this.string=string;}
SafeString.prototype.toString=SafeString.prototype.toHTML=function(){return''+this.string;};exports['default']=SafeString;module.exports=exports['default'];},{}],22:[function(require,module,exports){'use strict';exports.__esModule=true;exports.extend=extend;exports.indexOf=indexOf;exports.escapeExpression=escapeExpression;exports.isEmpty=isEmpty;exports.createFrame=createFrame;exports.blockParams=blockParams;exports.appendContextPath=appendContextPath;var escape={'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#x27;','`':'&#x60;','=':'&#x3D;'};var badChars=/[&<>"'`=]/g,possible=/[&<>"'`=]/;function escapeChar(chr){return escape[chr];}
...
+" \n  </button>\n";},"2":function(container,depth0,helpers,partials,data){return"  triadic\n";},"4":function(container,depth0,helpers,partials,data){var stack1,alias1=container.lambda,alias2=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"     <li><a href=\""
...
+"</form>\n\n";},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],32:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</button>\n";},"useData":true});},{"hbsfy/runtime":23}],33:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"  <button class=\"w3-bar-item w3-button w3-border tablink \n"
...
+".</p>\n  </div>\n</div>\n</div>\n\n</div>\n\n";},"useData":true});},{"hbsfy/runtime":23}],34:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){return"<!-- ==================================\n *            e j D i c t o             *\n * ==================================== *\n * (c)2012-2020 - Patrick Cardona       *\n * Licence GPL version 3 ou ultérieure  *\n * VOIR la licence complète à la racine *\n * ==================================== -->\n\n<!-- Template : zone de notification\n  notificationTemplate.hbs\n-->\n\n    <div class=\"w3-modal-content w3-round\">\n    <div class=\"w3-container\">\n      <p class=\"w3-right-align\">\n      <button class=\"w3-button texte-fonce\" onclick=\"$('#notification').hide()\">\n      <i class=\"icon-fermer\"></i>\n      </button>\n      </p>\n      <h4 id=\"titre_message\" class=\"w3-center texte-fonce\"></h4>\n      <p id=\"contenu_message\"></p>\n    </div>\n    </div>\n\n";},"useData":true});},{"hbsfy/runtime":23}],35:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var helper,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"\">\n\n\n\n";},"useData":true});},{"hbsfy/runtime":23}],37:[function(require,module,exports){exports.masquer_aide=function(){$("#aide").hide();};exports.afficher_aide=function(){$("#aide").show();};exports.alterner_section_aide=function(id){let section=document.getElementById(id);if(section.className.indexOf("w3-show")==-1){section.className+=" w3-show";}else{section.className=section.className.replace(" w3-show","");}};},{}],38:[function(require,module,exports){const Popup=require('./messageModule.js').Popup;const popup=new Popup();exports.inserer_mot=function(inputName){try{let choix=document.querySelector('input[name="'+inputName+'"]:checked').value;let num=inputName.slice(7);substituer_etiquette(choix,num)&&$("#form_"+num).hide()&&sessionStorage.setItem("ejdicto_form"+num,true);return true;}
catch(erreur){popup.afficherMessage(1);}};function substituer_etiquette(motChoisi,num){let maSaisie=document.getElementById("ma_saisie");let saisie=maSaisie.value;sortie=saisie.replace("_("+num+")_",motChoisi.trim());maSaisie.value=sortie;sessionStorage.setItem("dictee",sortie);actualiser_assistant(false);return true;}
exports.actualiser_assistant=function(messageTerminer=false){let nombre=0;let dictee;if(sessionStorage.getItem("dictee")){dictee=sessionStorage.getItem("dictee");}else{dictee=$("#ma_saisie").val();}
let indice;let nMots=10;let motif=""
for(indice=0;indice<nMots;indice++){motif="_("+((indice+1))+")_";if(dictee.indexOf(motif)!==-1){nombre++;$("#form_"+(indice+1)).show();}else{$("#form_"+(indice+1)).hide();}}
if(nombre>0){$("#assistant").show();$(".autres_boutons").hide();if(messageTerminer===true){popup.afficherMessage(6);return true;}}else{if(messageTerminer===false){messageAssistantIndisponible();}
$(".autres_boutons").show();$("#assistant").hide();}
return false;};function messageAssistantIndisponible(){let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==='true'){popup.afficherMessage(7);}}},{"./messageModule.js":43}],39:[function(require,module,exports){exports.inserer=function(){var args=arguments;var car=args[0];var cible=args[1];var zone=document.getElementById(cible);zone.focus();if(typeof zone.selectionStart!='undefined')
{let start=zone.selectionStart;let end=zone.selectionEnd;let insText=zone.value.substring(start,end);zone.value=zone.value.substr(0,start)+car+zone.value.substr(end);let pos;pos=start+car.length;zone.selectionStart=pos;zone.selectionEnd=pos;document.getElementById(cible).value=zone.value;}};},{}],40:[function(require,module,exports){function escape(s){var n=s;n=n.replace(/&/g,"&amp;");n=n.replace(/</g,"&lt;");n=n.replace(/>/g,"&gt;");return n;}
exports.diffString=function(o,n){let nbre=0;o=o.replace(/\s+$/,'');n=n.replace(/\s+$/,'');var out=diff(o==""?[]:o.split(/\s+/),n==""?[]:n.split(/\s+/));var str="";var oSpace=o.match(/\s+/g);if(oSpace==null){oSpace=["\n"];}else{oSpace.push("\n");}
...
let bilan="";if(nbre>0){bilan=2;}else{bilan=3;}
...
return{o:o,n:n};}},{}],41:[function(require,module,exports){const Popup=require('./messageModule.js').Popup;const popup=new Popup();const actualiser_assistant=require('./assistantModule.js').actualiser_assistant;const diffString=require('./diffModule.js').diffString;var exercice={saisie:"",fourni:"",attendu:"",erreurCode:0,correction:"",typeExercice:""};exercice.init=function(){this.saisie=document.getElementById("ma_saisie").value;this.attendu=document.getElementById("attendu").textContent;this.fourni=document.getElementById("fourni").textContent;this.erreurCode=0;this.correction="";this.typeExercice=document.getElementById("type_exercice").textContent;if(this.saisie.length>0){if(this.attendu.length>0){return true;}
else{this.erreurCode=2;console.log(this.erreurCode);return false;}}
else{this.erreurCode=1;return false;}};exercice.corriger=function(){let msgid;if(this.init()===true){var sortie=diffString(this.saisie,this.attendu);let msgid=sortie.bilan;popup.afficherMessage(msgid);}else{if(this.erreurCode===1){msgid=5;}else{msgid=4;}
popup.afficherMessage(msgid);}};exercice.terminer=function(){if(this.init()===true){let msgid;if(actualiser_assistant(true)){return false;}
var sortie=diffString(this.saisie,this.attendu);this.correction=sortie.corrigee.replace(/\n/g,"<\/ins><br><ins>");document.getElementById("corrige").innerHTML=this.correction;document.getElementById("zone_correction").style.display="block";document.getElementById("menu").style.display="none";document.getElementById("zone_saisie").style.display="none";if(sessionStorage.getItem(this.typeExercice)){sessionStorage.removeItem(this.typeExercice);}
return true;}else{if(this.erreurCode===1){msgid=5;}else{msgid=4;}
popup.afficherMessage(msgid);}};exercice.masquerCorrection=function(){document.getElementById("zone_correction").style.display="none";document.getElementById("zone_saisie").style.display="block";};exercice.recommencerSaisie=function(){document.getElementById("ma_saisie").value=document.getElementById("fourni").textContent;sessionStorage.clear();if(profil.retourne("ejdictoProfilAmenagement")){$("#assistant").hide();}};exports.exercice=exercice;},{"./assistantModule.js":38,"./diffModule.js":40,"./messageModule.js":43}],42:[function(require,module,exports){exports.filtrer=function(IDListe,motif){let filtre,ul,li,a,i,txtValue;filtre=motif.toUpperCase();ul=document.getElementById(IDListe);li=ul.getElementsByTagName("li");for(i=0;i<li.length;i++){a=li[i].getElementsByTagName("a")[0];txtValue=a.textContent||a.innerText;if(txtValue.toUpperCase().indexOf(filtre)>-1){li[i].style.display="";}else{li[i].style.display="none";}}}},{}],43:[function(require,module,exports){const infos=require('../../../static/config/popups.json').infos;class Popup{constructor(msgid='000'){this.msgid=msgid;this.message="Un message...";this.titre="Titre";}}
Popup.prototype.preparer=function(msgid){this.msgid=msgid;let info=infos[msgid];this.titre=info.titre;this.message=info.contenu;};Popup.prototype.afficherMessage=function(msgid){this.preparer(msgid);$("#titre_message").html(this.titre);$("#contenu_message").html(this.message);$("#notification").show();};exports.Popup=Popup;},{"../../../static/config/popups.json":82}],44:[function(require,module,exports){exports.derouler_navigation=function(){$("#menu_gauche").show();};exports.refermer_navigation=function(){$("#menu_gauche").hide();};},{}],45:[function(require,module,exports){exports.afficheRubrique=function(evt,nomRubrique){let i,rubriques,tablinks;rubriques=document.getElementsByClassName("rubrique");for(i=0;i<rubriques.length;i++){rubriques[i].style.display="none";}
tablinks=document.getElementsByClassName("tablink");for(i=0;i<rubriques.length;i++){tablinks[i].className=tablinks[i].className.replace(" triadic","");}
$('#'+nomRubrique).show();evt.currentTarget.className+=" triadic";return true;};},{}],46:[function(require,module,exports){var profil={};profil.retourne=function(cle,defaut){if(localStorage.getItem(cle)){valeur=localStorage.getItem(cle);}else{valeur=defaut;}
return valeur;};profil.changeNiveau=function(){let niveau=$("#niveau_choisi").val();localStorage.setItem("ejdictoProfilNiveau",niveau);};profil.changeAmenagement=function(){let amenagement=$("#amenagement_choisi").checked();localStorage.setItem("ejdictoProfilAmenagement",amenagement);};exports.profil=profil;},{}],47:[function(require,module,exports){"use strict";const versionApp=require('../package.json').version;const MSG=require('../static/config/messages.json').msg;window.afficheRubrique=require('./lib/scripts/ongletModule.js').afficheRubrique;window.exercice=require('./lib/scripts/exerciceModule.js').exercice;window.inserer=require('./lib/scripts/carspecModule.js').inserer;window.profil=require('./lib/scripts/profilModule.js').profil;window.inserer_mot=require('./lib/scripts/assistantModule.js').inserer_mot;window.actualiser_assistant=require('./lib/scripts/assistantModule.js').actualiser_assistant;window.afficher_aide=require('./lib/scripts/aideModule.js').afficher_aide;window.masquer_aide=require('./lib/scripts/aideModule.js').masquer_aide;window.alterner_section_aide=require('./lib/scripts/aideModule.js').alterner_section_aide;window.filtrer=require('./lib/scripts/filtre.js').filtrer;window.derouler_navigation=require('./lib/scripts/navigation.js').derouler_navigation;window.refermer_navigation=require('./lib/scripts/navigation.js').refermer_navigation;const Handlebars=require('hbsfy/runtime');const Navigo=require('navigo/lib/navigo');const chibi=require('chibijs/chibi');Handlebars.registerHelper("capitalisePremiereLettre",function(sChaine){if(typeof sChaine==='string'){return sChaine.charAt(0).toUpperCase()+sChaine.slice(1);}
return null;});Handlebars.registerHelper("cibleEstUneDictee",function(sCible){if(sCible=='dictee'){return true;}else{return false;}});Handlebars.registerHelper("interpreteLogique",function(bValeur){if(bValeur==="true"){return"Oui"}else{return"Non"}});Handlebars.registerHelper("interpreteNiveau",function(sChiffre){let niveau="";let etalon=sChiffre;switch(etalon){case"5":niveau="Cinquième";break;case"3":niveau="Troisième";break;default:return"Tous";}
return niveau;});Handlebars.registerHelper("estDuNiveauRequis",function(sNiveau){let niveauProfil=profil.retourne("ejdictoProfilNiveau",false);if(niveauProfil!==false){niveauProfil+="e";if(sNiveau===niveauProfil){return true;}else{return false;}}
return true;});Handlebars.registerHelper("existeEnVersionAmenagee",function(info_dictam){let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==="true"){if(info_dictam===true){return true;}else{return false;}}else{return true;}});Handlebars.registerHelper("cetteDicteeEstAmenagee",function(exercice){let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==="true"&&exercice==="dictée"){return true;}
return false;});Handlebars.registerHelper("afficheLesEtiquettes",function(texte,lacunes){let index;for(index=0;index<10;index++){texte=texte.replace(((index+1)).toString(),lacunes[index].trim());}
let sortie=texte.replace(new RegExp(/_\(/,'g'),"<span class='w3-tag w3-round clair'>");sortie=sortie.replace(new RegExp(/\)_/,'g'),"</span>");return sortie;});Handlebars.registerHelper("indexPlusUn",function(index){let indice=0;if(typeof index==='integer'){indice=++index;}else{indice=parseInt(index,10);indice=indice+1;}
return indice;});Handlebars.registerHelper("decoupeLaProposition",function(proposition){let mots=proposition.split("|");return mots;});Handlebars.registerHelper('encodeChaine',function(chaine){return new Handlebars.SafeString(chaine);});Handlebars.registerHelper("ceChoixEstMasque",function(indice){let formulaire="_form"+(indice+1);if(sessionStorage.getItem("ejdicto"+formulaire)){return true;}
return false;});const niveaux=require('../static/config/niveaux.json').niveaux;const menuTemplate=require("./menus/menuTemplate.hbs");const menuExerciceTemplate=require("./menus/menuExerciceTemplate.hbs");const menuListeTemplate=require("./menus/menuListeTemplate.hbs");Handlebars.registerPartial("barre",require("./composants/barreCaracteresTemplate.hbs"));Handlebars.registerPartial("sourceaudio",require("./composants/sourceAudioTemplate.hbs"));Handlebars.registerPartial("assistant",require("./composants/assistantDeLaSaisieTemplate.hbs"));Handlebars.registerPartial("apropos",require("./composants/aproposTemplate.hbs"));Handlebars.registerPartial("licence",require("./composants/licenceTemplate.hbs"));Handlebars.registerPartial("prise_en_main",require("./aides/aidePriseEnMain.hbs"));Handlebars.registerPartial("amelioration",require("./aides/aideAmelioration.hbs"));Handlebars.registerPartial("dictam",require("./aides/aideDictam.hbs"));Handlebars.registerPartial("usage_mobile",require("./aides/aideUsageMobile.hbs"));const erreurTemplate=require("./pages/erreurTemplate.hbs");const accueilTemplate=require("./pages/accueilTemplate.hbs");const listeTemplate=require("./pages/listeTemplate.hbs");const accueilExerciceTemplate=require("./pages/accueilExerciceTemplate.hbs");const ecouterTemplate=require("./pages/ecouterTemplate.hbs");const saisirTemplate=require("./pages/saisirTemplate.hbs");const mentionsTemplate=require("./pages/mentionsTemplate.hbs");const aideTemplate=require("./pages/aideTemplate.hbs");const consigneReecritureTemplate=require("./pages/consigneReecritureTemplate.hbs");const profilTemplate=require("./pages/profilTemplate.hbs");const formProfilTemplate=require("./pages/formProfilTemplate.hbs");const piedDePageTemplate=require("./composants/piedTemplate.hbs");const notificationTemplate=require("./composants/notificationTemplate.hbs");const zone_notification=notificationTemplate();window.addEventListener('load',()=>{const menu=$('#menu');const app=$('#app');const aide=$("#aide");const notification=$("#notification");const piedDePage=piedDePageTemplate({'version':versionApp});const dataMenuAccueil=require("../static/config/menu_accueil.json").menu;const menuAccueil=menuTemplate(dataMenuAccueil);const dataMenuListe=require("../static/config/menu_liste.json").menu;const dataMenuAide=require("../static/config/menu_aide.json").menu;const menuAide=menuTemplate(dataMenuAide);const dataMenuProfil=require("../static/config/menu_profil.json").menu;const menuProfil=menuTemplate(dataMenuProfil);const dataMenuModprefs=require("../static/config/menu_modprefs.json").menu;const menuModprefs=menuTemplate(dataMenuModprefs);const dataMenuDictee=require("../static/config/menu_dictee.json").menu;const dataMenuEcouter=require("../static/config/menu_ecouter.json").menu;const dataMenuSaisirDictee=require("../static/config/menu_saisir_dictee.json").menu;const dataMenuMentionsDictee=require("../static/config/menu_mentions_dictee.json").menu;const dataMenuReecriture=require("../static/config/menu_reecriture.json").menu;const dataMenuConsigne=require("../static/config/menu_consigne.json").menu;const dataMenuSaisirReecriture=require("../static/config/menu_saisir_reecriture.json").menu;const dataMenuMentionsReecriture=require("../static/config/menu_mentions_reecriture.json").menu;const formatAudio=require("../static/config/format_audio.json").source;const tableCaracteres=require("../static/config/table_caracteres.json").caracteres;let moduleJSONdata=require('../static/config/apropos.json');let rubriquesJSONdataApropos=require('../static/config/rubriques_apropos.json').rubriques;let modeleApropos={'app_name':'ejDicto','module':moduleJSONdata,'rubs':rubriquesJSONdataApropos,'version':versionApp};let dataLicence=require("../static/config/licence.json").licence;let rubriquesJSONdataLicence=require('../static/config/rubriques_licence.json').rubriques;let texte_page_1=dataLicence.pages[0].texte;let texte_page_2=dataLicence.pages[1].texte;let now=new Date();let actuel=now.getFullYear();let modeleLicence={'debut':dataLicence.debut,'actuel':actuel,'auteur':dataLicence.auteur,'texte_page_1':texte_page_1,'texte_page_2':texte_page_2,"rubs":rubriquesJSONdataLicence};let contenu={'modeleApropos':modeleApropos,'modeleLicence':modeleLicence}
const SommaireAide=aideTemplate(contenu);var root="/ejdicto/";var useHash=true;var hash='#!';var router=new Navigo(root,useHash,hash);router.on({'aide':function(){app.html(SommaireAide);menu.html(menuAide);},'liste/dictees':function(){let niveau=profil.retourne("ejdictoProfilNiveau",0)
let JSONdata=require('../static/config/liste_dictees.json');let contenu={'info':JSONdata,'exercice':'dictée','cible':'dictee','niveau':niveau}
let html=listeTemplate(contenu);dataMenuListe.exercice='dictée';const menuListe=menuListeTemplate(dataMenuListe);menu.html(menuListe);app.html(html);},'liste/reecritures':function(){let niveau=profil.retourne("ejdictoProfilNiveau",0)
let JSONdata=require('../static/config/liste_reecritures.json');let contenu={'info':JSONdata,'exercice':'réécriture','cible':'reecriture','niveau':niveau}
let html=listeTemplate(contenu);dataMenuListe.exercice='réécriture';const menuListe=menuListeTemplate(dataMenuListe);menu.html(menuListe);app.html(html);},'dictee/:id':function(params){let contenu={'did':params.id,'exercice':'dictée','consigne':MSG.consigneDictee,'consigneDicteeAmenagee':MSG.consigneDicteeAmenagee,'lien':'ecouter','legende':'écoute'};let html=accueilExerciceTemplate(contenu);dataMenuDictee.did=params.id;dataMenuDictee.exercice='dictée';dataMenuDictee.actionsMobile=[].slice.call(dataMenuDictee.actions).reverse();let menuD=menuExerciceTemplate(dataMenuDictee);menu.html(menuD);app.html(html);},'reecriture/:id':function(params){let contenu={'did':params.id,'exercice':'réécriture','consigne':MSG.consigneReecriture,'lien':'consigne','legende':'consigne'}
let html=accueilExerciceTemplate(contenu);dataMenuReecriture.did=params.id;dataMenuReecriture.exercice='réécriture';dataMenuReecriture.actionsMobile=[].slice.call(dataMenuReecriture.actions).reverse();let menuR=menuExerciceTemplate(dataMenuReecriture);menu.html(menuR);app.html(html);},'ecouter/:id':function(params){let rubriquesJSONdata=require('../static/config/rubriques_dictam.json').rubriques;let source="./static/data/dictee"+params.id+".json";let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==='true'){source="./static/data/dictam"+params.id+".json";}
fetch(source).then((response)=>{return response.json();}).then((data)=>{let contenu={'did':params.id,'sources':formatAudio,'fourni':data.fourni,'lacunes':data.lacunes||"",'exercice':'dictée','rubs':rubriquesJSONdata,'mots':data.consigne};let html=ecouterTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuEcouter.did=params.id;dataMenuEcouter.exercice='dictée';dataMenuEcouter.actionsMobile=[].slice.call(dataMenuEcouter.actions).reverse();let menuD=menuExerciceTemplate(dataMenuEcouter);menu.html(menuD);},'saisir/dictee/:id':function(params){let source="./static/data/dictee"+params.id+".json";let amenagement=profil.retourne("ejdictoProfilAmenagement",false);if(amenagement==='true'){source="./static/data/dictam"+params.id+".json";}
fetch(source).then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.caracteres=tableCaracteres;contenu.did=params.id;contenu.exercice='dictée';contenu.cible='dictee';contenu.attendu=data.attendu;contenu.fourni=data.fourni;if(sessionStorage.getItem("dictee")){contenu.saisie=sessionStorage.getItem("dictee");}else{contenu.saisie=contenu.fourni;}
if(amenagement){contenu.propositions=data.lacunes;}
let html=saisirTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuSaisirDictee.did=params.id;dataMenuSaisirDictee.exercice='dictée';dataMenuSaisirDictee.actionsMobile=[].slice.call(dataMenuSaisirDictee.actions).reverse();let menuD=menuExerciceTemplate(dataMenuSaisirDictee);menu.html(menuD);notification.html(zone_notification);},'saisir/reecriture/:id':function(params){fetch("./static/data/jecho"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.caracteres=tableCaracteres;contenu.did=params.id;contenu.fourni=data.fourni;contenu.attendu=data.attendu;contenu.saisie="";if(sessionStorage.getItem("reecriture")){contenu.saisie=sessionStorage.getItem("reecriture");}else{contenu.saisie=contenu.fourni;}
contenu.exercice='réécriture';contenu.cible='reecriture';let html=saisirTemplate(contenu);app.html(html);notification.html(zone_notification);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuSaisirReecriture.did=params.id;dataMenuSaisirReecriture.exercice='réécriture';dataMenuSaisirReecriture.actionsMobile=[].slice.call(dataMenuSaisirReecriture.actions).reverse();let menuR=menuExerciceTemplate(dataMenuSaisirReecriture);menu.html(menuR);notification.html(zone_notification);},'mentions/dictee/:id':function(params){fetch("./static/data/dictee"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.auteur=data.auteur;contenu.titre=data.titre;contenu.prof=data.prof;contenu.ouvrage=data.ouvrage;contenu.exercice='dictée';contenu.cible='dictee';contenu.remarque=data.remarque||"";contenu.voix=data.voix||"";let html=mentionsTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuMentionsDictee.did=params.id;dataMenuMentionsDictee.exercice='dictée';dataMenuMentionsDictee.cible='dictee';dataMenuMentionsDictee.actionsMobile=[].slice.call(dataMenuMentionsDictee.actions).reverse();let menuD=menuExerciceTemplate(dataMenuMentionsDictee);menu.html(menuD);},'mentions/reecriture/:id':function(params){fetch("./static/data/jecho"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.auteur=data.auteur;contenu.titre=data.titre;contenu.prof=data.prof;contenu.ouvrage=data.ouvrage;contenu.exercice='réécriture';contenu.cible='reecriture';let html=mentionsTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuMentionsReecriture.did=params.id;dataMenuMentionsReecriture.exercice='réécriture';dataMenuMentionsReecriture.cible='reecriture';dataMenuMentionsReecriture.actionsMobile=[].slice.call(dataMenuMentionsReecriture.actions).reverse();let menuR=menuExerciceTemplate(dataMenuMentionsReecriture);menu.html(menuR);},'consigne/:id':function(params){fetch("./static/data/jecho"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.consigne=data.consigne;contenu.fourni=data.fourni;let html=consigneReecritureTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuConsigne.did=params.id;dataMenuConsigne.exercice='réécriture';dataMenuConsigne.actionsMobile=[].slice.call(dataMenuConsigne.actions).reverse();let menuR=menuExerciceTemplate(dataMenuConsigne);menu.html(menuR);},'profil':function(){let niveau=profil.retourne('ejdictoProfilNiveau','tous');let amenagement=profil.retourne('ejdictoProfilAmenagement',false);let contenu={'niveau':niveau,'amenagement':amenagement,};let html=profilTemplate(contenu);app.html(html);menu.html(menuProfil);},'modprefs':function(){let checked;let amenagement=profil.retourne('ejdictoProfilAmenagement',false);if(amenagement==="true"||amenagement===true){checked="checked";}else{checked="";}
let contenu={'niveaux':niveaux,'checked':checked};let html=formProfilTemplate(contenu);app.html(html);menu.html(menuModprefs);},'*':function(){let html=accueilTemplate({"bienvenue":MSG.bienvenue});app.html(html);app.htmlAppend(piedDePage);menu.html(menuAccueil);menu.show();sessionStorage.clear();}}).resolve();router.on(function(){let html=accueilTemplate({"bienvenue":"Bienvenue dans votre espace d'entrainement en orthographe !"});app.html(html);menu.html(menuAccueil);sessionStorage.clear();}).resolve();router.notFound(function(){const html=erreurTemplate({couleur:'yellow',titre:'Erreur 404 - Page introuvable !',message:'Ce chemin n\'existe pas.'});menu.html(menuAccueil)
app.html(html);});});},{"../package.json":25,"../static/config/apropos.json":62,"../static/config/format_audio.json":63,"../static/config/licence.json":64,"../static/config/liste_dictees.json":65,"../static/config/liste_reecritures.json":66,"../static/config/menu_accueil.json":67,"../static/config/menu_aide.json":68,"../static/config/menu_consigne.json":69,"../static/config/menu_dictee.json":70,"../static/config/menu_ecouter.json":71,"../static/config/menu_liste.json":72,"../static/config/menu_mentions_dictee.json":73,"../static/config/menu_mentions_reecriture.json":74,"../static/config/menu_modprefs.json":75,"../static/config/menu_profil.json":76,"../static/config/menu_reecriture.json":77,"../static/config/menu_saisir_dictee.json":78,"../static/config/menu_saisir_reecriture.json":79,"../static/config/messages.json":80,"../static/config/niveaux.json":81,"../static/config/rubriques_apropos.json":83,"../static/config/rubriques_dictam.json":84,"../static/config/rubriques_licence.json":85,"../static/config/table_caracteres.json":86,"./aides/aideAmelioration.hbs":26,"./aides/aideDictam.hbs":27,"./aides/aidePriseEnMain.hbs":28,"./aides/aideUsageMobile.hbs":29,"./composants/aproposTemplate.hbs":30,"./composants/assistantDeLaSaisieTemplate.hbs":31,"./composants/barreCaracteresTemplate.hbs":32,"./composants/licenceTemplate.hbs":33,"./composants/notificationTemplate.hbs":34,"./composants/piedTemplate.hbs":35,"./composants/sourceAudioTemplate.hbs":36,"./lib/scripts/aideModule.js":37,"./lib/scripts/assistantModule.js":38,"./lib/scripts/carspecModule.js":39,"./lib/scripts/exerciceModule.js":41,"./lib/scripts/filtre.js":42,"./lib/scripts/navigation.js":44,"./lib/scripts/ongletModule.js":45,"./lib/scripts/profilModule.js":46,"./menus/menuExerciceTemplate.hbs":48,"./menus/menuListeTemplate.hbs":49,"./menus/menuTemplate.hbs":50,"./pages/accueilExerciceTemplate.hbs":51,"./pages/accueilTemplate.hbs":52,"./pages/aideTemplate.hbs":53,"./pages/consigneReecritureTemplate.hbs":54,"./pages/ecouterTemplate.hbs":55,"./pages/erreurTemplate.hbs":56,"./pages/formProfilTemplate.hbs":57,"./pages/listeTemplate.hbs":58,"./pages/mentionsTemplate.hbs":59,"./pages/profilTemplate.hbs":60,"./pages/saisirTemplate.hbs":61,"chibijs/chibi":1,"hbsfy/runtime":23,"navigo/lib/navigo":24}],48:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,alias5=container.lambda,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=lookupProperty(helpers,"if").call(alias1,(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(2,data,0,blockParams,depths),"inverse":container.program(4,data,0,blockParams,depths),"data":data,"loc":{"start":{"line":18,"column":2},"end":{"line":23,"column":9}}}))!=null?stack1:"")
...
return undefined};return"    <button class=\"w3-button w3-"
...
+"</button>\n";},"4":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</a>\n";},"6":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=lookupProperty(helpers,"if").call(depth0!=null?depth0:(container.nullContext||{}),(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(7,data,0),"inverse":container.program(10,data,0),"data":data,"loc":{"start":{"line":37,"column":2},"end":{"line":50,"column":9}}}))!=null?stack1:"");},"7":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"      <button onclick=\""
...
+" \n      </button>\n";},"8":function(container,depth0,helpers,partials,data){return" w3-border-top";},"10":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"      <a href=\""
...
+"</a>\n";},"12":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=lookupProperty(helpers,"if").call(depth0!=null?depth0:(container.nullContext||{}),(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(13,data,0),"inverse":container.program(15,data,0),"data":data,"loc":{"start":{"line":57,"column":2},"end":{"line":62,"column":9}}}))!=null?stack1:"");},"13":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"      <button onclick=\""
...
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(1,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":17,"column":0},"end":{"line":81,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],49:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=lookupProperty(helpers,"if").call(alias1,(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(2,data,0,blockParams,depths),"inverse":container.program(4,data,0,blockParams,depths),"data":data,"loc":{"start":{"line":17,"column":2},"end":{"line":21,"column":9}}}))!=null?stack1:"")
+"\n<!-- Actions -->\n"
...
+"</a>\n";},"6":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=lookupProperty(helpers,"if").call(depth0!=null?depth0:(container.nullContext||{}),(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(7,data,0),"inverse":container.program(9,data,0),"data":data,"loc":{"start":{"line":25,"column":2},"end":{"line":30,"column":9}}}))!=null?stack1:"");},"7":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"      <button onclick=\""
...
+"</a>\n";},"11":function(container,depth0,helpers,partials,data){return"  aménagées\n";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(1,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":0},"end":{"line":42,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],50:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"  <a href=\""
...
+"</a>\n";},"3":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=lookupProperty(helpers,"if").call(alias1,(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(4,data,0,blockParams,depths),"inverse":container.program(6,data,0,blockParams,depths),"data":data,"loc":{"start":{"line":27,"column":2},"end":{"line":32,"column":9}}}))!=null?stack1:"")
+"  \n<!-- Actions -->\n"
...
+"</h1>\n  </div>\n</div>\n";},"4":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"    <button class=\"w3-button w3-"
...
+"</button>\n";},"6":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"    <a href=\""
...
return undefined};return((stack1=lookupProperty(helpers,"if").call(depth0!=null?depth0:(container.nullContext||{}),(depth0!=null?lookupProperty(depth0,"bouton"):depth0),{"name":"if","hash":{},"fn":container.program(9,data,0),"inverse":container.program(11,data,0),"data":data,"loc":{"start":{"line":36,"column":2},"end":{"line":41,"column":9}}}))!=null?stack1:"");},"9":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"      <button onclick=\""
...
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(3,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":26,"column":0},"end":{"line":47,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],51:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"              "
...
+"\n";},"3":function(container,depth0,helpers,partials,data){var stack1,helper,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"              "
...
+"\n";},"5":function(container,depth0,helpers,partials,data){return" au moyen de l'assistant <span class=\"texte-lien\">\n            (<i class=\"icon-assistant\"></i>)</span>";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var stack1,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</h1>\n  </div>\n </div>\n </div>\n\n";},"useData":true});},{"hbsfy/runtime":23}],53:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</div>\n\n</div>\n";},"usePartial":true,"useData":true});},{"hbsfy/runtime":23}],54:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</p>\n</div>\n</div>\n</div>\n";},"5":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"<div class=\"w3-padding-24\">\n<div class=\"w3-bar w3-light-grey w3-border\">\n<span id=\"autres_boutons\">\n"
...
+" \n  </button>\n";},"7":function(container,depth0,helpers,partials,data){return"  triadic\n";},"9":function(container,depth0,helpers,partials,data){return"  w3-hide-small\n";},"11":function(container,depth0,helpers,partials,data){return"class=\"rubrique\"\n";},"13":function(container,depth0,helpers,partials,data){return"      Puis affichez le texte aménagé \n            et notez vos choix au brouillon avec méthode : <br>\n            <ol><li>Mon choix 1 : ...</li><li>Etc</li></ol>\n";},"15":function(container,depth0,helpers,partials,data){return"   Puis écoutez-la de nouveau, en la notant sur votre \n   cahier de brouillon. \n";},"17":function(container,depth0,helpers,partials,data,blockParams){var stack1,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"<div id=\"texte\" class=\"rubrique\"\nstyle=\"display: none\">\n<div class=\"w3-container\">\n    <h3 class=\"texte-fonce\">Texte aménagé</h3>\n    <p style=\"max-width: 500px\">\n    "
...
+"    </ul>\n</div>\n</div>\n";},"18":function(container,depth0,helpers,partials,data,blockParams){var alias1=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+((stack1=lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"cetteDicteeEstAmenagee")||(depth0&&lookupProperty(depth0,"cetteDicteeEstAmenagee"))||alias2).call(alias1,(depth0!=null?lookupProperty(depth0,"exercice"):depth0),{"name":"cetteDicteeEstAmenagee","hash":{},"data":data,"blockParams":blockParams,"loc":{"start":{"line":102,"column":6},"end":{"line":102,"column":39}}}),{"name":"if","hash":{},"fn":container.program(17,data,0,blockParams,depths),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":102,"column":0},"end":{"line":124,"column":7}}}))!=null?stack1:"");},"usePartial":true,"useData":true,"useDepths":true,"useBlockParams":true});},{"hbsfy/runtime":23}],56:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</option>\n";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+" </a>\n     </li>\n";},"6":function(container,depth0,helpers,partials,data,blockParams,depths){var alias1=container.lambda,alias2=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"     <li><a href=\"#!"
+alias2(alias1((depths[1]!=null?lookupProperty(depths[1],"cible"):depths[1]),depth0))
+"/"
+alias2(alias1((depth0!=null?lookupProperty(depth0,"id"):depth0),depth0))
...
+"\n";},"3":function(container,depth0,helpers,partials,data){var helper,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"     <p>Avec la voix de "
...
+"</span></td>\n</table>\n</div>\n\n</div>\n";},"useData":true});},{"hbsfy/runtime":23}],61:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"    </div>\n";},"2":function(container,depth0,helpers,partials,data,blockParams){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=container.invokePartial(lookupProperty(partials,"assistant"),(lookupProperty(helpers,"decoupeLaProposition")||(depth0&&lookupProperty(depth0,"decoupeLaProposition"))||container.hooks.helperMissing).call(depth0!=null?depth0:(container.nullContext||{}),blockParams[0][0],{"name":"decoupeLaProposition","hash":{},"data":data,"blockParams":blockParams,"loc":{"start":{"line":27,"column":17},"end":{"line":27,"column":51}}}),{"name":"assistant","hash":{"nom":(data&&lookupProperty(data,"index"))},"data":data,"blockParams":blockParams,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators}))!=null?stack1:"");},"4":function(container,depth0,helpers,partials,data){return"    <span>\n     <button onclick=\"actualiser_assistant()\" class=\"w3-button w3-right\"\n     title=\"Assistant\">\n      <i class=\"icon-assistant\"></i>\n     </button>\n    </span>\n";},"6":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return((stack1=container.invokePartial(lookupProperty(partials,"barre"),depth0,{"name":"barre","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators}))!=null?stack1:"");},"8":function(container,depth0,helpers,partials,data){return" onclick=\"$('#assistant').hide();$('.autres_boutons').show()\" \n ";},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data,blockParams){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</div>\n";},"usePartial":true,"useData":true,"useBlockParams":true});},{"hbsfy/runtime":23}],62:[function(require,module,exports){module.exports=[{"appname":"Agrégateur de scripts (bundle) : Browserify","auteur":"Browserify.org","site":"http://browserify.org/","licence":"MIT","code":"https://github.com/browserify"},{"appname":"Serveur de développement : Budo","auteur":"Matt DesLauriers","site":"https://github.com/mattdesl/budo/blob/master/README.md","licence":"MIT","code":"https://github.com/mattdesl/budo"},{"appname":"Manipulation du DOM : Chibi","auteur":"Kyle Barrow","site":"https://github.com/kylebarrow/chibi","licence":"MIT","code":"https://github.com/kylebarrow/chibi"},{"appname":"Minification du code CSS : cleanCSS","auteur":"Jakub Pawlowicz","site":"https://www.npmjs.com/package/clean-css","licence":"MIT","code":"https://github.com/jakubpawlowicz/clean-css"},{"appname":"Template : Handlebars","auteur":"Yehuda Katz","site":"https://handlebarsjs.com/","licence":"MIT","code":"https://github.com/wycats/handlebars.js"},{"appname":"Handlebars avec Browserify : hbsfy","auteur":"Esa-Matti Suuronen","site":"https://www.npmjs.com/package/hbsfy","licence":"MIT","code":"https://github.com/epeli/node-hbsfy"},{"appname":"Icones : IcoMoon Free Version","auteur":"Keyamoon","site":"https://icomoon.io/","licence":"GPL / CC BY 4.0","code":"https://github.com/Keyamoon/IcoMoon-Free/archive/master.zip"},{"appname":"Comparaison de chaines : JsDiff","auteur":"John Resig","site":"http://ejohn.org/","licence":"MIT","code":"https://github.com/kpdecker/jsdiff"},{"appname":"Minification du code JS : jsmin","auteur":"D. Crockford, F. Marcia, P. Krumins","site":"https://www.npmjs.com/package/jsmin","licence":"All right reserved","code":"https://github.com/pkrumins/node-jsmin"},{"appname":"Routage : Navigo","auteur":"Krasimir Tsonev","site":"https://github.com/krasimir/navigo","licence":"MIT","code":"https://github.com/krasimir/navigo"},{"appname":"Service Worker : vanilla-pwa","auteur":"Arjun Mahishi","site":"https://www.npmjs.com/package/vanilla-pwa","licence":"MIT","code":"https://github.com/arjunmahishi/vanilla-pwa"},{"appname":"Style : W3.css","auteur":"W3schools","site":"https://www.w3schools.com/w3css/default.asp","licence":"Usage libre","code":"https://github.com/JaniRefsnes/w3css"}]},{}],63:[function(require,module,exports){module.exports={'source':[{'format':{'extension':'ogg','type':'ogg'}},{'format':{'extension':'aac','type':'aac'}},{'format':{'extension':'mp3','type':'mpeg'}}]}},{}],64:[function(require,module,exports){module.exports={'licence':{'auteur':'Patrick Cardona','debut':'2012','pages':[{"texte":"Le code JavaScript de cette page est un \
      ...
      Consultez la GNU GPL pour plus de détails."},{"texte":"En tant que permission supplémentaire selon \
      ...
      http://www.gnu.org/licenses/</a>"}]}}},{}],65:[function(require,module,exports){module.exports=[{"id":"51","titre":"La rose","niveau":"5e","dictam":false},{"id":"52","titre":"Un comportement étrange","niveau":"5e","dictam":false},{"id":"53","titre":"Un château inquiétant","niveau":"5e","dictam":false},{"id":"54","titre":"Les maximes de Scapin","niveau":"5e","dictam":false},{"id":"55","titre":"Le chagrin de Charlemagne","niveau":"5e","dictam":false},{"id":"56","titre":"Une mésaventure de Renart","niveau":"5e","dictam":true},{"id":"57","titre":"Chant d'amour","niveau":"5e","dictam":false},{"id":"31","titre":"Le cerf","niveau":"3e","dictam":true},{"id":"32","titre":"Le tourisme","niveau":"3e","dictam":false},{"id":"33","titre":"La villa Aurore (1)","niveau":"3e","dictam":false},{"id":"34","titre":"La villa Aurore (2)","niveau":"3e","dictam":false},{"id":"35","titre":"Ma mère et la maladie","niveau":"3e","dictam":false},{"id":"36","titre":"La fontaine","niveau":"3e","dictam":true},{"id":"37","titre":"L'épuisement des soignants","niveau":"3e","dictam":true},{"id":"38","titre":"Esthétique du pays basque","niveau":"3e","dictam":false}]},{}],66:[function(require,module,exports){module.exports=[{"id":"501","titre":"Remplacement de groupes nominaux [1]","niveau":"5e"},{"id":"502","titre":"Remplacement de groupes nominaux [2]","niveau":"5e"},{"id":"51","titre":"Le monstre marin","niveau":"5e"},{"id":"52","titre":"Accords dans la dictée 52","niveau":"5e"},{"id":"57","titre":"Réécriture du texte de la dictée 57 : chant d'amour","niveau":"5e"},{"id":"DIAL5E","titre":"Réécriture d'un dialogue","niveau":"5e"},{"id":"31","titre":"À Montigny","niveau":"3e"},{"id":"32","titre":"Accords dans la dictée 32","niveau":"3e"},{"id":"PR14","titre":"Texte D - Les leçons du chat","niveau":"3e"},{"id":"PR16","titre":"Texte F - Un maître bienveillant","niveau":"3e"},{"id":"PR19","titre":"Texte I - Un naufrage","niveau":"3e"}]},{}],67:[function(require,module,exports){module.exports={'menu':{'couleur':'fonce','contexte':{'bouton':true,'titre':'ejDicto','icone':'☰','action':'derouler_navigation()',},'items':[{'icone':"<i class='icon-liste'></i>",'legende':'Dictées','lien':'#!liste/dictees'},{'icone':"<i class='icon-liste'></i>",'legende':'Réécritures','lien':'#!liste/reecritures'}],'actions':[{'bouton':false,'icone':"<i class='icon-profil'></i>",'legende':'Profil','lien':'#!profil'},{'bouton':false,'icone':"<i class='icon-aide'></i>",'legende':'Aide','lien':'#!aide'}]}}},{}],68:[function(require,module,exports){module.exports={'menu':{'couleur':'clair','contexte':{'bouton':false,'titre':'Aide','icone':"<i class='icon-retourner'></i>",'action':'#!'},'items':[],'actions':[]}}},{}],69:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Consigne','icone':"<i class='icon-retourner'></i>",'action':'#!liste/reecritures'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-info'></i>",'legende':'Mentions légales','lien':'#!mentions/reecriture'},{'bouton':false,'icone':"<i class='icon-plume'></i>",'legende':'Saisir la réécriture','lien':'#!saisir/reecriture'}]}}},{}],70:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Accueil','icone':"<i class='icon-retourner'></i>",'action':'#!liste/dictees'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-info'></i>",'legende':'Mentions légales','lien':'#!mentions/dictee'},{'bouton':false,'icone':"<i class='icon-plume'></i>",'legende':'Saisir la dictée','lien':'#!saisir/dictee'},{'bouton':false,'icone':"<i class='icon-ecouteurs'></i>",'legende':'Écouter la dictée','lien':'#!ecouter'}]}}},{}],71:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Écoute','icone':"<i class='icon-retourner'></i>",'action':'#!liste/dictees'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-info'></i>",'legende':'Mentions légales','lien':'#!mentions/dictee'},{'bouton':false,'icone':"<i class='icon-plume'></i>",'legende':'Saisir la dictée','lien':'#!saisir/dictee'}]}}},{}],72:[function(require,module,exports){module.exports={'menu':{'exercice':'exercice','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Liste','icone':"<i class='icon-retourner'></i>",'action':'#!'},'items':[],'actions':[{'bouton':true,'icone':"<i class='icon-recherche'></i>",'legende':'Filtrer la liste','lien':"$('#panneau_recherche').toggle()"}]}}},{}],73:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Mentions légales','icone':"<i class='icon-retourner'></i>",'action':'#!liste/dictees'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-plume'></i>",'legende':'Saisir la dictée','lien':'#!saisir/dictee'},{'bouton':false,'icone':"<i class='icon-ecouteurs'></i>",'legende':'Écouter la dictée','lien':'#!ecouter'}]}}},{}],74:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Mentions légales','icone':"<i class='icon-retourner'></i>",'action':'#!liste/reecritures'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-plume'></i>",'legende':'Saisir la réécriture','lien':'#!saisir/reecriture'},{'bouton':false,'icone':"<i class='icon-consigne'></i>",'legende':'Consigne de la réécriture','lien':'#!consigne'}]}}},{}],75:[function(require,module,exports){module.exports={'menu':{'couleur':'clair','contexte':{'bouton':false,'titre':'Modification du profil','icone':"<i class='icon-gauche'></i>",'action':'#!profil'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-finir'></i>",'legende':'Appliquer','lien':'#!profil'},]}}},{}],76:[function(require,module,exports){module.exports={'menu':{'couleur':'clair','contexte':{'bouton':false,'titre':'Profil','icone':"<i class='icon-retourner'></i>",'action':'#!'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-editer'></i>",'legende':'Modifier le profil','lien':'#!modprefs'},]}}},{}],77:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Accueil','icone':"<i class='icon-retourner'></i>",'action':'#!liste/reecritures'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-info'></i>",'legende':'Mentions légales','lien':'#!mentions/reecriture'},{'bouton':false,'icone':"<i class='icon-plume'></i>",'legende':'Saisir la réécriture','lien':'#!saisir/reecriture'},{'bouton':false,'icone':"<i class='icon-consigne'></i>",'legende':'Consigne de la réécriture','lien':'#!consigne'}]}}},{}],78:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Saisie','icone':"<i class='icon-retourner'></i>",'action':'#!liste/dictees'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-info'></i>",'legende':'Mentions légales','lien':'#!mentions/dictee'},{'bouton':false,'icone':"<i class='icon-ecouteurs'></i>",'legende':'Écouter la dictée','lien':'#!ecouter'}]}}},{}],79:[function(require,module,exports){module.exports={'menu':{'did':'','couleur':'blue-gray','contexte':{'bouton':false,'titre':'Saisie','icone':"<i class='icon-retourner'></i>",'action':'#!liste/reecritures'},'items':[],'actions':[{'bouton':false,'icone':"<i class='icon-info'></i>",'legende':'Mentions légales','lien':'#!mentions/reecriture'},{'bouton':false,'icone':"<i class='icon-consigne'></i>",'legende':'Consigne de la réécriture','lien':'#!consigne'}]}}},{}],80:[function(require,module,exports){module.exports={"msg":{"bienvenue":"Bienvenue dans votre espace d'entrainement en orthographe&nbsp;!","consigneDictee":"D'abord, écoutez la dictée <span class='texte-lien'>(<i class='icon-ecouteurs'></i>)</span> et notez-la au brouillon.","consigneDicteeAmenagee":"Écoutez la dictée <span class='texte-lien'>(<i class='icon-ecouteurs'></i>)</span> en parcourant le \
        texte aménagé au-dessous pour y découvrir les choix proposés. Notez-les au brouillon.","consigneReecriture":"D'abord, lisez attentivement la consigne <span class='texte-lien'>\
  (<i class='icon-consigne'></i>)</span> de la réécriture. Notez au brouillon les passages à transformer."}}},{}],81:[function(require,module,exports){module.exports={'niveaux':[{'chiffre':'5','nom':'Cinquième'},{'chiffre':'3','nom':'Troisième'},{'chifrre':'*','nom':'Tous'}]}},{}],82:[function(require,module,exports){module.exports={"infos":[{"msgid":"0","titre":"Message de cette application","contenu":"Ce message permet de tester le module de notification !",},{"msgid":"1","titre":"Mode d'emploi","contenu":"Vous devez sélectionner un mot !",},{"msgid":"2","titre":"Bilan","contenu":"Vous pouvez encore améliorer votre saisie.",},{"msgid":"3","titre":"Bilan","contenu":"Parfait ! Aucune erreur.",},{"msgid":"4","titre":"Erreur 4 dans l'application","contenu":"Le texte attendu est manquant."},{"msgid":"5","titre":"Mode d'emploi","contenu":"Aucun texte n'a été saisi."},{"msgid":"6","titre":"Assistant","contenu":"Vous n'avez pas encore remplacé toutes les lacunes."},{"msgid":"7","titre":"Assistant indisponible","contenu":"Il ne reste aucune lacune à remplacer."}]}},{}],83:[function(require,module,exports){module.exports={'rubriques':[{'lien':'apropos','legende':"À propos"},{'lien':'fabrique','legende':"Fabrique"},{'lien':'credits','legende':"Crédits"}]}},{}],84:[function(require,module,exports){module.exports={'rubriques':[{'lien':'conseils','legende':"Conseils"},{'lien':'texte','legende':"Texte aménagé"},{'lien':'choix','legende':"Propositions"}]}},{}],85:[function(require,module,exports){module.exports={'rubriques':[{'lien':'page1','legende':"1"},{'lien':'page2','legende':"2"}]}},{}],86:[function(require,module,exports){module.exports={'caracteres':[{car:'«'},{car:'—'},{car:'»'},{car:'…'},{car:'œ'},{car:'Œ'},{car:'É'},{car:'À'}]}},{}]},{},[47]);