...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- ==================================\n *            e j D i c t o             *\n * ==================================== *\n * (c)2012-2020 - Patrick Cardona       *\n * Licence GPL version 3 ou ultérieure  *\n * VOIR la licence complète à la racine *\n * ==================================== -->\n\n<!-- Template : mentions légales\n  mentionsReecritureTemplate.hbs\n -->\n\n   <div class=\"w3-container w3-padding-48\">\n		<div class=\"w3-card\">\n			   <header class=\"w3-green w3-padding\">\n"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"titre") || (depth0 != null ? lookupProperty(depth0,"titre") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"titre","hash":{},"data":data,"loc":{"start":{"line":26,"column":13},"end":{"line":26,"column":24}}}) : helper)))
    + "</h3>\n				      <p><span class=\"w3-text-green\">Référence :</span>\n				       <span class=\"auteur\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"auteur") || (depth0 != null ? lookupProperty(depth0,"auteur") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"auteur","hash":{},"data":data,"loc":{"start":{"line":28,"column":32},"end":{"line":28,"column":44}}}) : helper)))
    + "</span>,\n                        <span class=\"ouvrage\"><em>"
    + alias4(((helper = (helper = lookupProperty(helpers,"ouvrage") || (depth0 != null ? lookupProperty(depth0,"ouvrage") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"ouvrage","hash":{},"data":data,"loc":{"start":{"line":29,"column":50},"end":{"line":29,"column":63}}}) : helper)))
    + "</em></span>\n	 			      </p>\n  	 			      <p><span class=\"w3-text-green\">Réécriture proposée par \n  	 			      </span>"
    + alias4(((helper = (helper = lookupProperty(helpers,"prof") || (depth0 != null ? lookupProperty(depth0,"prof") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"prof","hash":{},"data":data,"loc":{"start":{"line":32,"column":20},"end":{"line":32,"column":30}}}) : helper)))
    + "</p>\n			  </div>\n		</div>\n   </div>\n";
},"useData":true});
