...
let html=reecritureTemplate(contenu);let menuD=menuDicteeTemplate({'did':params.id,'item':menuReecritureItems});menu.html(menuD);app.html(html);},'ecouter/:id':function(params){let contenu={'did':params.id};let html=ecouterTemplate(contenu);let menuD=menuDicteeTemplate({'did':params.id,'item':menuDicteeItems});menu.html(menuD);app.html(html);},'saisir/:id':function(params){fetch('http://example.com/movies.json').then((response)=>{return response.json();}).then((data)=>{console.log(data);});fetch("./static/data/dictee"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.caracteres=[{car:'«'},{car:'—'},{car:'»'},{car:'…'},{car:'œ'},{car:'Œ'},{car:'É'},{car:'À'}];contenu.did=params.id;contenu.texte=data.texte;contenu.saisie="";if(sessionStorage.getItem("dictee")){contenu.saisie=sessionStorage.getItem("dictee");}
